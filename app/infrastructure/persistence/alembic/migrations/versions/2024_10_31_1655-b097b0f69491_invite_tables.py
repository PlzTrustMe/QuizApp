...
Revision ID: b097b0f69491
Revises: 39ba5639f2c2
Create Date: 2024-10-31 16:55:11.303411
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "user_requests_id", name=op.f("pk_user_requests")
        ),
        sa.UniqueConstraint(
            "user_requests_id", name=op.f("uq_user_requests_user_requests_id")
        ),
    )
